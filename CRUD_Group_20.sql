...
CREATE TABLE `customer` (
  ...
  `CustomerPh` varchar(30) NOT NULL,
  `PaymentStatus` varchar(10) DEFAULT NULL,
  `Amount` double DEFAULT NULL,
  `RoomAllocated` int DEFAULT NULL,
  PRIMARY KEY (`CustomerPh`),
  KEY `RoomAllocated` (`RoomAllocated`),
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`RoomAllocated`) REFERENCES `rooms` (`RoomNo`)
...
-- Dump completed on 2021-12-05 22:38:24
